...
### CEmu Source is the Ground Truth

When in doubt about hardware behavior, CEmu's source code is authoritative. Key files:
- `cpu.c` - CPU instruction implementation
- `timers.c` - All timer logic including OS Timer
- `control.c` - Control port behavior
- `interrupt.c` - Interrupt sources and handling
- `port.c` - I/O port routing table

---

*Last updated: During Milestone 5 boot debugging*
